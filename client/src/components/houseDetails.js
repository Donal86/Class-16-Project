...
class HouseDetails extends Component {
    constructor(props) {
        super(props);
        this.props.PropertiesStore.houseDetails(queryString.parse(this.props.location.search).id);
        this.state = {
            imgItems: [],
            activeIndex: 0,
            imgModal: {},
    ...
    async componentDidMount() {
        ...
        await PropertiesStore.houseDetails(queryString.parse(this.props.location.search).id);
